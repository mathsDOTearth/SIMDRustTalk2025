...
unsafe impl SimdElem for f64 {
    ...
    #[inline(always)] unsafe fn zero() -> Self::Reg { () }
    #[inline(always)] unsafe fn load(_: *const f64) -> Self::Reg { () }
    #[inline(always)] unsafe fn store(_: *mut f64, _: Self::Reg) {}
    #[inline(always)] unsafe fn fmadd(_: Self::Reg, _: Self::Reg, _: Self::Reg) -> Self::Reg { () }
    #[inline(always)] unsafe fn reduce(_: Self::Reg) -> f64 { 0.0 }
}
...
unsafe impl SimdElem for f32 {
    ...
    #[inline(always)] unsafe fn zero() -> Self::Reg { () }
    #[inline(always)] unsafe fn load(_: *const f32) -> Self::Reg { () }
    #[inline(always)] unsafe fn store(_: *mut f32, _: Self::Reg) {}
    #[inline(always)] unsafe fn fmadd(_: Self::Reg, _: Self::Reg, _: Self::Reg) -> Self::Reg { () }
    #[inline(always)] unsafe fn reduce(_: Self::Reg) -> f32 { 0.0 }
}
...
// RVV targets
#[cfg(target_arch = "riscv64")]
pub unsafe fn dot_generic<E: SimdElem>(_: &[E::Scalar], _: &[E::Scalar]) -> E::Scalar {
    unimplemented!("Use specific RVV bindings instead for RISC-V")
}
